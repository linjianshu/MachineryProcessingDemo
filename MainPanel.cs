    ...
    public partial class MainPanel : FrmBase
    {
        ...
        private void MainPanel_Load(object sender, EventArgs e)
        {
            ...
            using (var context = new Model())
            {
                ...
                var cBBdbRCntlPntBases = context.C_BBdbR_CntlPntBase.Where(s =>
                        s.CntlPntTyp == 1.ToString() && s.Enabled == 1.ToString())
        ...
        private void GenerateProductDoc()
        {
            using (var context = new Model())
            {
                ...
                var cProductProcessingDocument = context.C_ProductProcessingDocument.Where(s => s.ProductBornCode == ProductIDTxt.Text.Trim()
        ...
        private void ProductProcessingDocTurn()
        {
            using (var context = new Model())
            {
                ...
                _cProductProcessing.Offline_type = 2; //强制下机
        ...
        public void InialToDoTasks()
        {
            ...
            List<DataGridViewColumnEntity> lstColumns1 = new List<DataGridViewColumnEntity>
            {
                ...
                new DataGridViewColumnEntity()
                {
                    DataField = "ProcedureCode", HeadText = "工序名称", Width = 15, WidthType = SizeType.Percent
                },
                new DataGridViewColumnEntity()
                {
                ...
                new DataGridViewColumnEntity()
                {
                    DataField = "TaskState", HeadText = "工序状态", Width = 15, WidthType = SizeType.Percent
                }
            };
            ucDataGridView2.Columns = lstColumns1;
            ucDataGridView2.ItemClick += UcDataGridView2_ItemClick;
            // ucDataGridView2.DoubleClick += UcDataGridView2_DoubleClick;
        ...
        public void InitialDidTasks()
        {
            ...
            List<DataGridViewColumnEntity> lstColumns = new List<DataGridViewColumnEntity>
            {
                ...
                new DataGridViewColumnEntity()
                {
                    DataField = "ProductBornCode", HeadText = "产品出生证", Width = 50, WidthType = SizeType.Percent
                },
                new DataGridViewColumnEntity()
                {
                    DataField = "ProcedureCode", HeadText = "工序名称", Width = 15, WidthType = SizeType.Percent
                ...
                new DataGridViewColumnEntity()
                {
                    DataField = "Name", HeadText = "质检结果", Width = 30, WidthType = SizeType.Percent
                }
            };
            ...
            var lstSource = new List<object>();
            for (var i = 0; i < 50; i++)
            {
                var model = new TestGridModel()
                {
                    Id = i.ToString(),
                    Age = 3 * i,
                    Name = "姓名" + i,
            ...
            if (!hasExitProductTask())
            {
                ...
                if (dataSource is APS_ProcedureTaskDetail apsProcedureTaskDetail)
                {
                    ...
                    if (dialogResult == DialogResult.OK)
                    {
                        ...
                        var scanOnlineForm = new ScanOnlineForm(_staffId, _staffCode, _staffName, apsProcedureTaskDetail.ProductBornCode)
                        {
                        ...
                        if (scanOnlineForm.CheckTaskValidity(apsProcedureTaskDetail.ProcedureCode))
                        {
                            ...
                            //判断首件
                            bool hasFirstRecord = scanOnlineForm.HasFirstRecord();
        ...
        private List<APS_ProcedureTaskDetail> GetDidProcedureTask()
        {
            ...
            using (var context = new Model())
            {
                ...
                var apsProcedureTasks = context.APS_ProcedureTask.Where(s => s.EquipmentID == 1&&s.IsAvailable ==true)
                ...
                foreach (var apsProcedureTask in apsProcedureTasks)
                {
                    ...
                    var apsProcedureTaskDetails = context.APS_ProcedureTaskDetail.Where(s =>
                        ...
                        s.TaskTableID == apsProcedureTask.ID && s.TaskState == 3).OrderBy(s => s.LastModifiedTime);
        ...
        private List<APS_ProcedureTaskDetail> GetToDoProcedureTask()
        {
            ...
            using (var context = new Model())
            {
                ...
                foreach (var apsProcedureTask in apsProcedureTasks)
                {
                    ...
                    var apsProcedureTaskDetails = context.APS_ProcedureTaskDetail.Where(s =>
                            s.EquipmentID == apsProcedureTask.EquipmentID &&
                            s.ProcedureCode == apsProcedureTask.ProcedureCode && s.TaskState != 3 &&
        ...
        private void SelfCheckColorJudge()
        {
            using (var context = new Model())
            {
                ...
                {
                    if (context.C_ProductQualityData.Any(s => s.ProductBornCode == ProductIDTxt.Text.Trim() && s.ProcedureCode == _cProductProcessing.ProcedureCode))
                    {
                        ProductionStatusInfoPanel.Controls.Find("control002", false).First().BackColor
                            = Color.MediumSeaGreen;
                    }
        ...
        private void SelfCheckItemEvent(object sender, EventArgs e)
        {
            ...
            controls.Visible = false;
            selfCheckItemForm.Location = new Point(0
                , 0);
        ...
        private bool SelfItemCheck()
        {
            ...
            using (var context = new Model())
            {
                ...
                var cProductQualityDatas = context.C_ProductQualityData.Where(s => s.ProductBornCode == ProductIDTxt.Text.Trim()
                                                                                 && s.ProcedureName == CurrentProcessTxt.Text.Trim() && s.CollectValue == null && s.CheckResult == null).ToList();
                // if (!cProductQualityDatas.Any())
                // {
                //     return false; 
                // }
                foreach (var cProductQualityData in cProductQualityDatas)
                {
                    ...
                    var aProcedureSelfCheckingConfig = context.A_ProcedureSelfCheckingConfig.FirstOrDefault(s =>
                        s.ItemCode == cProductQualityData.ItemCode && s.IsEnable == true
                                                                                                                                                          && s.IsAvailable == true && s.IsRequired == true
                                                                                                                                                          && s.ProcedureID.ToString() == _cProductProcessing.ProcedureID);
        ...
        private void OpenLoginForm(object sender, EventArgs e)
        {
            ...
            using (var context = new Model())
            {
                ...
                cLoginInProcessing.OfflineTime = DateTime.Now;
                context.SaveChanges();
            }
